...
# Caminho para os arquivos .npz da pasta de teste
dataset_path = 'clipData/trainTest'
...
all_labels = np.hstack(dashboard_labels)  # Pegamos os labels dos dashboards como referência
